...
kGenProgに各個体の生成にかかった時間を計測する処理を追加し，さらに得られた個体情報をビルドの成否および解であるかによって分類した．その後，全体の生成時間のうち修正に成功したプログラムの生成経路にかかった時間およびビルドに失敗した個体に費やした時間を定量的に計測することで，自動プログラム修正における無駄な経路や修正に役に立った経路の時間的コストを調査した．結果として，修正対象のバグによっては全個体の生成時間のうち80\%前後がビルドに失敗する個体に費やされたことや，多くのプログラムで修正に成功した個体に費やした時間が全体の10\%を下回ったなどの結果を得た．
}
