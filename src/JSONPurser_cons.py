...
num = 39
run = 30
out2 = open("C:/Users/yuuki/Downloads/build/fuga/summary_consx_"+str(num)+".txt", 'w')
...
for k in range(1,run + 1):
    instance.purse("C:/Users/yuuki/Downloads/build/fuga/Lang"+str(num)+"_cons_"+str(k)+".json", "C:/Users/yuuki/Downloads/build/fuga/result"+str(num)+"_consx_"+str(k)+".txt")
